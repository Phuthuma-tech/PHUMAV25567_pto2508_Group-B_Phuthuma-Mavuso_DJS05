 ...
 * query string via `useSearchParams`. This means the homepage URL always
 * fully describes what the user is looking at, so navigating to a show and
 * back (browser back, or a "back to shows" link) restores the exact same
 * view without any extra state-management plumbing.
 *
